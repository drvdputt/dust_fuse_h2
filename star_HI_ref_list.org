...
** My fit results
      ...
      | BD+56d524  |      1 | self                        |     | IUE L       | fail (lya emission)                              |
      | HD023060   |      1 | self                        |     | IUE L       | good                                             |
      | HD037332   |      1 | self                        |     | IUE H       | ok                                               |
      | HD037525   |      1 | self                        |     | IUE H       | ok                                               |
      | HD046202   |      1 | self                        |     | IUE H       | ok, noisy                                        |
      | HD047129   |      1 | self                        |     | IUE H       | ok, but need to remove features                  |
      | HD051013   |      7 | AC1996 21 cm                | y   | IUE H       | ok                                               |
      | HD062542   |      1 | self                        |     | IUE H, STIS | fail (continuum wrong)                           |
      | HD093028   |      1 | self                        |     | IUE H       | ok, noisy                                        |
      | HD093827   |      1 | self                        |     | IUE H       | broad and shift                                  |
      | HD094493   |    1,3 | self                        | y   | IUE H, STIS | good                                             |
      | HD096675   |      1 | self                        |     | IUE H       | ok                                               |
      | HD097471   |      1 | self                        |     | IUE L       | good                                             |
      | HD099872   |     1a | self                        |     | IUE L, STIS | good                                             |
      | HD152248   |      1 | self                        |     | IUE H       | ok, but needs double                             |
      | HD179406   |      1 | self                        |     | IUE H       | good                                             |
      | HD190603   |      1 | self                        |     | IUE H, STIS | too broad                                        |
      | HD197770   |      1 | self                        |     | IUE H, STIS | fail (weird plot)                                |
      | HD209339   |      1 | self                        |     | IUE L, STIS | good                                             |
      | HD216898   |      1 | self                        |     | IUE H       | ok, too broad, big peaks affecting continuum fit |
      | HD235874   |      1 | self                        |     | IUE L       | good (slight shift)                              |
      | HD326329   |     12 | Should probably be 13 or 14 | yes | IUE H       | ok                                               |
