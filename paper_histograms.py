...
def rho_histogram(ax, xparam, yparam, comment):
    ...
    ax.text(std_null * 0.8, height1 + y_offset, "$\\sigma$", ha="right")
    # n sigmfa arrow
...
rho_histogram(ax[0], "1_RV", "NH_AV", "insignificant")
rho_histogram(ax[1], "A1000_AV", "NH_AV", "significant")
